...
internals.parseValues = function(str, options) {
  ...
  for (var i = 0, il = parts.length; i < il; ++i) {
    var part = parts[i];
    var pos =
      part.indexOf("]=") === -1 ? part.indexOf("=") : part.indexOf("]=") + 1;
...
module.exports = function(str, options) {
  ...
  options.delimiter =
    typeof options.delimiter === "string" || Utils.isRegExp(options.delimiter)
      ...
      : internals.delimiter;
  options.depth =
    typeof options.depth === "number" ? options.depth : internals.depth;
  options.arrayLimit =
  ...
  var tempObj =
    typeof str === "string" ? internals.parseValues(str, options) : str;
