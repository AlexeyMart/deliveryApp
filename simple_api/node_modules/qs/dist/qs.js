  ...
  })(
    {
      ...
      2: [
        function(require, module, exports) {
          ...
          module.exports = function(str, options) {
            ...
            var tempObj =
              typeof str === "string"
                ? internals.parseValues(str, options)
                : str;
        ...
        function(require, module, exports) {
          ...
          module.exports = function(obj, options) {
            ...
            var generateArrayPrefix =
              internals.arrayPrefixGenerators[arrayFormat];
      ...
      4: [
        function(require, module, exports) {
          ...
          for (var h = 0; h < 256; ++h) {
            internals.hexTable[h] =
              "%" + ((h < 16 ? "0" : "") + h.toString(16)).toUpperCase();
          }
          ...
          exports.encode = function(str) {
            ...
            for (var i = 0, il = str.length; i < il; ++i) {
              ...
              if (c < 0xd800 || c >= 0xe000) {
                out +=
                  internals.hexTable[0xe0 | (c >> 12)] +
                  internals.hexTable[0x80 | ((c >> 6) & 0x3f)] +
                  internals.hexTable[0x80 | (c & 0x3f)];
                continue;
              }
              ...
              out +=
                internals.hexTable[0xf0 | (c >> 18)] +
                internals.hexTable[0x80 | ((c >> 12) & 0x3f)] +
                internals.hexTable[0x80 | ((c >> 6) & 0x3f)] +
                internals.hexTable[0x80 | (c & 0x3f)];
            }
