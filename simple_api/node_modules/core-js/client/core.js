  ...
  /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        $def($def.P, "String", {
          trim: __webpack_require__(16)(/^\s*([\s\S]*\S)?\s*$/, "$1")
        });
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        module.exports = function(name) {
          return (
            store[name] ||
            (store[name] =
              (global.Symbol && global.Symbol[name]) ||
              __webpack_require__(8).safe("Symbol." + name))
          );
        };
        ...
        function $redef(O, key, val, safe) {
          if ($.isFunction(val)) {
            ...
            $.hide(
              val,
              SRC,
              base ? String(base) : tpl.replace(/hasOwnProperty/, String(key))
            );
        ...
        $def(
          ...
          "String",
          {
            ...
            startsWith: function startsWith(searchString /*, position = 0 */) {
              ...
              searchString += "";
              return (
                that.slice(index, index + searchString.length) === searchString
              );
            }
          }
        );
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        $def(
          $def.S +
            $def.F *
              !__webpack_require__(49)(function(iter) {
                Array.from(iter);
              }),
          "Array",
          {
        ...
        if ($.FW && $.DESC) {
          if (!CORRECT_NEW || !ALLOWS_RE_WITH_FLAGS) {
            $RegExp = function RegExp(pattern, flags) {
              ...
              return CORRECT_NEW
                ? new Base(
                    patternIsRegExp && !flagsIsUndefined
                      ? pattern.source
                      : pattern,
                    flags
                  )
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function isPromise(it) {
          return (
            isObject(it) &&
            (useNative ? cof.classof(it) == "Promise" : RECORD in it)
          );
        }
          ...
          getConstructor: function(wrapper, NAME, IS_MAP, ADDER) {
            ...
            __webpack_require__(63)(C.prototype, {
              ...
              delete: function(key) {
                ...
                return (
                  $has(key, WEAK) &&
                  $has(key[WEAK], this[ID]) &&
                  delete key[WEAK][this[ID]]
                );
              },
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var reflect = {
          ...
          construct: function construct(target, argumentsList /*, newTarget*/) {
            var proto = assert.fn(arguments.length < 3 ? target : arguments[2])
                .prototype,
          ...
          set: function set(target, propertyKey, V /*, receiver*/) {
            ...
            if ($.has(ownDesc, "value")) {
              if (ownDesc.writable === false || !isObject(receiver))
                return false;
              existingDescriptor =
                $.getDesc(receiver, propertyKey) || $.desc(0);
        ...
        module.exports = function(that, minLength, fillChar, left) {
          ...
          if (fillLen < 0 || fillLen === Infinity) {
            throw new RangeError(
              "Cannot satisfy string length " + minLength + " for string: " + S
            );
          }
          ...
          var sFillVal = repeat.call(
            sFillStr,
            Math.ceil(fillLen / sFillStr.length)
          );
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function createDictReduce(IS_TURN) {
          return function(object, mapfn, init) {
            ...
            if (IS_TURN) {
              memo =
                init == undefined ? new (generic(this, Dict))() : Object(init);
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var MapIter = createChainIterator(function() {
          ...
          return step.done
            ...
            : $iter.step(
                0,
                call(this[ITER], this[FN], step.value, this[ENTRIES])
              );
        });
        ...
        __webpack_require__(63)($forProto, {
          ...
          array: function(fn, that) {
            var result = [];
            forOf(
              fn != undefined ? this.map(fn, that) : this,
              false,
              result.push,
              result
            );
        ...
        $def($def.P + $def.F, "Array", {
          turn: function(fn, target /* = [] */) {
            ...
            var memo = target == undefined ? [] : Object(target),
              ...
              index = 0;
            while (length > index)
              if (fn(memo, O[index], index++, this) === false) break;
            return memo;
          }
        });
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        addLocale("ru", {
          ...
          months:
            "Январ:я|ь,Феврал:я|ь,Март:а|,Апрел:я|ь,Ма:я|й,Июн:я|ь," +
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        $def($def.G + $def.F, {
          log: __webpack_require__(23)(log.log, log, {
            enable: function() {
              enabled = true;
            },
            disable: function() {
        ...
        function setStatics(keys, length) {
          $.each.call(keys.split(","), function(key) {
            if (length == undefined && key in $Array)
              ...
              statics[key] = __webpack_require__(13)(
                Function.call,
                [][key],
                length
              );
