  ...
  !(function(c) {
    ...
    function(U, T, d) {
      ...
      c(c.P + c.F * E, "Array", {
        ...
        c(c.P, "String", { trim: d(15)(/^\s*([\s\S]*\S)?\s*$/, "$1") }),
        c(c.S, "Date", {
          now: function() {
            return +new Date();
          }
          ...
          (l = !(i & a.F) && k && c in k),
            (l && c in o) ||
              ...
              n && !f(k[c])
                ...
                : (h = p && f(g) ? e(Function.call, g) : g),
              (o[c] = h),
              p && ((o.prototype || (o.prototype = {}))[c] = g));
      }
      var c = h(2),
        b = c.g,
        d = c.core,
    ...
    function(f, k, b) {
      ...
      f.exports = function(g, n, s, p, l, r) {
        var o = c.g[g],
          ...
          m = {};
        return (
          c.DESC && c.isFunction(f) && (r || (!h && k.forEach && k.entries))
            ? ((f = n(function(b, c) {
              ...
              c.each.call(
                ...
                function(a) {
                  var b = "add" == a || "set" == a;
                  a in k &&
                    c.hide(f.prototype, a, function(c, d) {
              ...
              "size" in k &&
                c.setDesc(f.prototype, "size", {
                  get: function() {
                    return this[e].size;
                  }
                }))
            : ((f = p.getConstructor(n, g, l, q)), b(59)(f.prototype, s)),
          b(5).set(f, g),
          (m[g] = f),
          d(d.G + d.W + d.F, m),
          b(51)(f),
    ...
    function(h, i, b) {
      function c(f, c) {
        e.each.call(f.split(","), function(e) {
          c == a && e in g
            ? (d[e] = g[e])
            : e in [] && (d[e] = b(12)(Function.call, [][e], c));
        });
      }
      var e = b(2),
        f = b(9),
